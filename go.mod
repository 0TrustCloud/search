...
require (
	github.com/0TrustCloud/guikit v1.2.3
	github.com/0TrustCloud/orchid_log v0.1.0
	github.com/0TrustCloud/orchid_sync v1.0.5
	github.com/0TrustCloud/product_otrust v0.1.0
	github.com/0TrustCloud/product_security v0.1.0
...
require (
	...
	github.com/0TrustCloud/secure_data_format v1.0.1 // indirect
